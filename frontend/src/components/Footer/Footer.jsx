    ...
    return (
        <FooterObj className="bg-base100 p-4 text-white relative z-40">
            <div className="grid sm:grid-cols-2 grid-cols-1 w-full mt-0 sm:mt-3">
                <span
                    className="text-sm text-center sm:text-left text-neutral-100 mt-1">Copyright © 2022 - Ibai Farina</span>
                <ul className="grid grid-cols-2 gap-3 mx-auto sm:ml-auto sm:mr-0 text-xs mt-2 sm:mt-1 text-neutral-400 sm:text-neutral-100">
