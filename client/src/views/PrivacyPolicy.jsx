    ...
    return (
        <div className="container p-20 text-justify">
            ...
            <p>At musicquiz, accessible from musicquiz.me, one of our main priorities is the privacy of our visitors.
                This Privacy Policy document contains types of information that is collected and recorded by musicquiz
                and how we use it.</p>
            ...
            <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with
                regards to the information that they shared and/or collect in musicquiz. This policy is not applicable
                to any information collected offline or via channels other than this website. Our Privacy Policy was
                created with the help of the <a href="https://www.termsfeed.com/privacy-policy-generator/">Free Privacy
            ...
            <TitleH2>Information we collect</TitleH2>
            ...
            <TitleH2>How we use your information</TitleH2>
            ...
            <p>musicquiz follows a standard procedure of using log files. These files log visitors when they visit
            ...
            <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are
                used in their respective advertisements and links that appear on musicquiz, which are sent directly to
            ...
            <p>Note that musicquiz has no access to or control over these cookies that are used by third-party
                advertisers.</p>

            <TitleH2>Third Party Privacy Policies</TitleH2>

            <p>musicquiz's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to
            ...
            <TitleH2>CCPA Privacy Rights (Do Not Sell My Personal Information)</TitleH2>
            ...
            <TitleH2>GDPR Data Protection Rights</TitleH2>
            ...
            <p>musicquiz does not knowingly collect any Personal Identifiable Information from children under the age of
