...
export const VolumeSlider = (props) => {
    ...
    return (
        <div className="flex items-center mx-2 bg-base-100 btn btn-ghost no-animation">
            <VolumeSliderInput type="range" ref={RangeRef} min="0" max="100" className="range range-xs"
                               onChange={(e) => setVolume(e.target.value)}/>
            <button onClick={muteSound} className="p-1 hover:scale-110">
                {volume > 0 ?
                    <svg xmlns="http://www.w3.org/2000/svg" className="text-base-content h-5 w-5" fill="none"
                         viewBox="0 0 24 24"
