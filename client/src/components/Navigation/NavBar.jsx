    ...
    return (
        ...
        <nav className="navbar">
            ...
            <div className={`menu-content ${isOpen ? "visible" : "hidden"}`}>
                <div className="ml-3 lg:ml-0 text-sm md:flex-grow">
                ...
                <div className="ml-3 mb-3 lg:m-0">
                    <a href="https://paypal.me/zellius" className="btn link-btn-component">Donate </a>
                </div>
            </div>
            <div className="changeThemeContainer mx-4 right-14 absolute z-50">
                <div title="Change Theme" className="dropdown dropdown-end">
                    ...
                    <div className="dropdown-content bg-base-200 text-base-content rounded-t-box rounded-b-box top-0 w-52 overflow-y-auto shadow-lg mt-16">
                        <div className="grid grid-cols-1 gap-3 p-3" tabIndex="0">
                            <div className="outline-base-content overflow-hidden rounded-lg outline-2 outline-offset-2" data-set-theme="auax" data-act-class="outline">
                                <div data-theme="auax" className="bg-base-100 text-base-content w-full cursor-pointer font-sans">
                            ...
                            <div className="outline-base-content overflow-hidden rounded-lg outline-2 outline-offset-2" data-set-theme="halloween" data-act-class="outline">
                            ...
                            <div className="outline-base-content overflow-hidden rounded-lg outline-2 outline-offset-2" data-set-theme="dracula" data-act-class="outline">
                            ...
                            <div className="outline-base-content overflow-hidden rounded-lg outline-2 outline-offset-2" data-set-theme="synthwave" data-act-class="outline">
                            ...
                            <div className="outline-base-content overflow-hidden rounded-lg outline-2 outline-offset-2" data-set-theme="lofi" data-act-class="outline">
                            ...
                            <div className="outline-base-content overflow-hidden rounded-lg outline-2 outline-offset-2" data-set-theme="coffee" data-act-class="outline">
